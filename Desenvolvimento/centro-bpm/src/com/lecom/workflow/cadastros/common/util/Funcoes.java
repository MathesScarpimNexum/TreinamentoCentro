...
/**
 * Classe responsavel por agregar os m�todos de tratamentos e formata��es comuns
 * a todo o projeto
 * 
 * @author TODOS
 * @data Junho 2019
...
public class Funcoes {
	...
	public static void closeConnection(Connection connection, Logger logger) {
		...
		try {
			...
			logger.error("Erro ao tentar fechar conex�o Workflow!", e);
	...
	/**
	 * Funcao que retorna uma String com espa�os a Esquerda
	 * 
	 * @param valor
	 * @param casas
	 * @return {@link String}
	...
	/**
	 * Metodo que busca os dados do Fluxo de Par�metro
	 * 
	...
	public static String[] getDadosUsuario(Integer codUsuarioWF, String desLoginWF, Integer codUsuarioLiderWF,
		...
		try {
			...
			e.printStackTrace();
			logger.error("[Erro ao buscar dados do Usu�rio]: ", e);
	...
	/*
	 * * * * * * * Fun��o calcula diferen�a entre 2 hor�rios, no formato HH:MM, em
	...
	/**
	 * Recupera o e-mail informado no cadastro de par�metros
	 * 
	 * @return DES_FROM
	 */
	...
	/**
	 * Pega E-Mail definido para ser usado no modo de testes, para cada formul�rio e
	 * vers�o necess�rios
	 * 
	...
	/**
	 * Metodo que l� arquivo properties com parametros e retorna um mapa.
	 * 
	 * @param nomeArquivo
	 * @return
	 * @throws Exception
	...
	/**
	 * Fun��o que retorna o diret�rio base do Workflow Pode ser utilizado para a
	 * cria��o de arquivos (para impress�o, relat�rios, etc.)
	 * 
	 * @return diret�rio base do Workflow (no tomcat, [tomcat]/webapps/workflow/)
	 */
	...
	/*
	 * blocoParalelo, caso "0" serve para 2 possibilidades ( 1 - n�o h� separa��o de
	...
	private static boolean gravarLecHistorico(Connection connection, Logger logger, Integer codProcesso, Integer codEtapa, Integer codCiclo, String obs, String usuarioExecutor, Integer blocoParalelo) throws SQLException {
		...
		try {
			...
			// Grava a Etapa e Ciclo que foi atualizado o historico, como valida��o para que
			// n�o seja duplicada a Observa��o no processo.
	...
	/**
	 * Funcao que retorna uma string preenchida com a string especificada �
	 * esquerda, com tamanho de acordo com o par�metro informado.
	 * 
	 * @param source
	 * @param filler
	 * @param casas
	...
	/**
	 * Retorna "selected" caso as informa��es forem iguais
	 * 
	 * @author Carlos Henrique Leda
	 * @param valor1 1� valor a ser comparado
	 * @param valor2 2� valor a ser comparado
	 * @return (String) String decorrente da compara��o
	 */
	...
	/*
	 * * * * * * * Fun��o soma 2 quantidades de horas, no formato HH:MM Ex : hrA =
	...
	/**
	 * M�todo que resgata os Dados do Iniciador do Processo
	 * 
	...
	/**
	 * Cria arquivo contendo texto passado como par�metro.
	 * 
	 * @param filename
	 * @param text
	 * @param append
	 ...
	 * no formato "0#" com zeros � esquerda, com tamanho de acordo com o par�metro
	 * informado.
	 * 
	 * @param numero
	 * @param casas
	...
	/**
	 * Verifica se o processo execurado est� no modo de testes ou n�o
	 * 
	 * @param Connection cnWF
	...
	/**
	 * Verifica se a aplica��o externa executada est� no modo de testes ou n�o
	 * 
	 * @param Connection cnWF
	 * @param String     url ( parte final da URL da aplica��o Externa, pois o
	 *                   come�o ser� sempre igual, com o endere�o da aplica��o )
	 * @return String S / N ( onde S = Sim, N = N�o ( default ) )
	 */
	public static String isModoTesteApp(Connection cnWF, String url) {
		...
		try {
			...
			// VERIFICA SE A APLICA��O EXTERNA EST� NO MODO DE TESTES
	...
	/**
	 * Pega a exce��o gerada e retorna em formato String, para ser colocada no log.
	 * 
	 * @param e
	 * @return
	 */
	...
	/**
	 * Este m�todo garante a flexibilidade da utiliza��o da m�ltiplas base de dados
	 * 
	...
	/*
	 * Retorna o nome do M�s do Ano com base no c�digo do mesmo
	 */
	...
	/**
	 * Metodo que executa uma consulta sql gen�rica e retorna um mapa com as
	 * informacoes
	 * 
	 * @param connection
	 * @param sql
	...
	public static Calendar getDataLimiteBasica(Calendar dataGravacao, String retornoSLA,
		...
		Calendar dataLimite = new CalculaTempoLimite(dataGravacao, tempoAtraso, turnoSemanaMap, diasNaoTrabalhadosList)
				.getDataLimite();
		return dataLimite;
	}

	/**
	 * Calcula tempo limite da etapa em milissegundos quando o prazo limite � uma
	 * data
	 * 
	 * @param dataGravacao
	 * @param dataLimite
	...
	public static long getTempoLimiteInMillis(Calendar dataGravacao, Calendar dataLimite,
		...
		try {
			...
			while (dataAux.compareTo(dataLimite) <= 0) {
				...
				// verifica se esta na lista de dias n�o trabalhados
	...
	/**
	 * Retorna um mapa com os hor�rios cadastrados de turnos (<dia>,
	...
	/**
	 * Retorna todos os dias n�o trabalhados
	 * 
	 * @param connection
	 * @return
	 * @throws Exception
	...
	/**
	 * Funcao para escrever por extenso valores num�ricos
	 * @param valor. Ex : 55
	...
	/**
	 * Obtem o c�digo da vers�o ativa do formul�rio a partir do c�digo do formul�rio
	 * @param connection
	 * @param codForm
	 * @return
	 * @throws Exception 
	 */
	private String getCodVersaoFormAtivo(Connection connection, Logger logger, String codForm) throws Exception {
		String codVersao = "0";
		...
		try (PreparedStatement pst = connection.prepareStatement(sql.toString())) {
			...
			logger.error("ERRO AO CONSULTAR A VERS�O DO FORMULARIO: ", e);
			throw e;
		}
	 ...
	 * @throws Exception 
	 */
	private String getModoTesteForm(Connection connection, Logger logger, String codForm, String codVersao) throws Exception {
	...
	/**
	 * Obtem o c�digo da ciclo da etapa a partir do c�digo da etapa e processo
	 * @param connection
	 * @param codProcesso
	 * @param codEtapa
	 * @return
	 * @throws Exception 
	 */
	private String getMaxCodCicloProcesso(Connection connection, Logger logger, String codProcesso, String codEtapa) throws Exception {
		String codCiclo = "";
